...
X_train <- read.table("rprj/UCI HAR Dataset/train/X_train.txt", header=FALSE)
X_test <- read.table("rprj/UCI HAR Dataset/test/X_test.txt", header=FALSE)
Y_train <- read.table("rprj/UCI HAR Dataset/train/y_train.txt", header=FALSE)
Y_test <- read.table("rprj/UCI HAR Dataset/test/y_test.txt", header=FALSE)
...
activities <- read.table("rprj/UCI HAR Dataset/activity_labels.txt", header=FALSE)
...
subject_train <- read.table("rprj/UCI HAR Dataset/train/subject_train.txt", header=FALSE)
subject_test <- read.table("rprj/UCI HAR Dataset/test/subject_test.txt", header=FALSE)
